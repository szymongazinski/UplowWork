...
chrome.runtime.onMessage.addListener((m,s,reply)=>respond(async()=>{
 ...
 if(m.type==='COMMIT')throw new Error('Automatyczna publikacja jest wyłączona. Kliknij końcowy przycisk samodzielnie na platformie.');
 if(m.type==='CHECK'){
