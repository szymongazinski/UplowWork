...
for(const name of ['manifest.json','background.js','runner.js','dom.js','facebook-page.js','local-settings.js','schedule.js','tiktok-schedule-ui.js','policy.js','captions.js','options.js','store.js','icon16.png','icon48.png','icon128.png'])copyFileSync(path.join(root,'extension',name),path.join(root,'dist',name));
